({
    ...
    ExportBudgetData:function(component,event,helper){
        ...
        var action = component.get("c.FetchKIVolumeBudgetRecords");
           ...
           if (state === "SUCCESS") {   
               ...
               if(result.length > 0){
                        ...
                        return null;
                         ...
                         columnDivider = ',';
                         lineDivider =  '\n';
                         keys1 =["Territory_Code__c","Budget_Year__c","Business_Line__c","Assigned_KI_Volume__c","Discretionary_Budget__c"];
                         keys =["Territory Code","Budget Year","Business Line","Assigned KI Volume","Discretionary Budget"];
                      ...
                      hiddenElement.download = 'Ki Volume and Disc Budget Export.csv';
