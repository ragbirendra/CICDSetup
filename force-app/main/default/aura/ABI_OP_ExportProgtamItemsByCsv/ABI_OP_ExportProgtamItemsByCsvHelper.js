({
    ...
    getProgramData: function(component, yearVal){
    ...
    getStatusData :function(component,yearVal,selectedProgram){
        console.log('yarandprogram+'+yearVal+''+selectedProgram);
         var selectedYear = component.get("v.selectedYr");
        ...
        statusAction.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                var records = response.getReturnValue();
                console.log('recordsstartus',response.getReturnValue());
