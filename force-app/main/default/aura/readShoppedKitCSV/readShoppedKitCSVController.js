      ...
      debugger;
        ...
        for(var i=0;i<resultToSave.length;i++)
        {
            ...
            if(resultToSave[i].ShopkitSAPNumber !='' && resultToSave[i].ShopkitTemporaryItemNumbers !='' ){
                ...
                errorArr.push($A.get("$Label.c.ABI_OP_SAPorTEMPValidation")+' Please check Row number:' +a);
            ...
            if((resultToSave[i].ShopkitSAPNumber.length >7) || ((resultToSave[i].ShopkitSAPNumber.length<7)&&(resultToSave[i].ShopkitSAPNumber.length!=0))){
                //alert('Invalid SAP item number...');
                  errorArr.push($A.get("$Label.c.ABI_OP_SAPNumberIncorrectValidation")+' Please check Row number:' +a);
            ...
            if(formattedshopkitStartDate == 'NaN/NaN/NaN' ||formattedshopkitStartDate == undefined ){
                errorArr.push($A.get("$Label.c.ABI_OP_StartDateValidation")+' Please check Row number:' +a);
            ...
            if(formattedshopkitEndDate == 'NaN/NaN/NaN' ||formattedshopkitEndDate == undefined ){
                errorArr.push($A.get("$Label.c.ABI_OP_EndDateValidation")+' Please check Row number:' +a);
            ...
            if(!shopkitStartDateMatch.match(dateExp) || shopkitStartDateMatch==null || shopkitStartDateMatch== ''){
                errorArr.push('Start Date cannot be Null or Empty. Please check Row number:' +a);
                // component.set("v.msgToPass" ,$A.get("$Label.c.ABI_OP_StartDateValidation")+' Please check Row number:'+(i+1) );
                // component.set("v.openModal",true);
                // return;
            }
            if(!shopkitEndDateMatch.match(dateExp) ||  shopkitEndDateMatch==null || shopkitEndDateMatch== ''){
                errorArr.push('End Date cannot be Null or Empty. Please check Row number:' +a);
                // component.set("v.msgToPass" ,$A.get("$Label.c.ABI_OP_EndDateValidation")+' Please check Row number:'+(i+1) );
                // component.set("v.openModal",true);
                // return;
            }
            ...
            if (d1 > d2) {
                ...
                errorArr.push($A.get("$Label.c.ABI_OP_StartDateGreater")+' Please check Row number:' +a);
            ...
            if(isNaN(resultToSave[i].ShopkitSAPNumber) ||isNaN(resultToSave[i].ShopkitPrice) || isNaN(resultToSave[i].ShopkitQty)|| isNaN(resultToSave[i].Year)){
                ...
                errorArr.push($A.get("$Label.c.ABI_OP_NAN_SAPPriceYearQuantity")+'Please check Row number:' +a);
                //  component.set("v.msgToPass" ,$A.get("$Label.c.ABI_OP_NAN_SAPPriceYearQuantity")+' Please check Row number:'+(i+1) );
                // component.set("v.openModal",true); 
                //    return; 
            }
            if(resultToSave[i].Year == '' || resultToSave[i].Year==null){
            ...
            if(YearList.indexOf(parseInt(resultToSave[i].Year))==-1)
            {
                ...
                errorArr.push($A.get("$Label.c.ABI_OP_YearSelection")+' Please check Row number:' +a);
                
            }
            if(!(resultToSave[i].BusinessLine =='Out of Home' || resultToSave[i].BusinessLine =='In Home')){
                errorArr.push($A.get("$Label.c.ABI_OP_BusinessLineSelection")+'Please check Row number:' +a);
            }
            if(resultToSave[i].ShoppedKitName == '' || resultToSave[i].ShoppedKitName ==null){
                errorArr.push('Shopped Kit Name should not be empty. Please Check Row:' +a);
            }
            if(resultToSave[i].ProgramName == '' || resultToSave[i].ProgramName ==null){
                errorArr.push('Program Name should not be null or empty. Please Check Row:' +a);
            }
            if(resultToSave[i].ShopkitPrice == '' || resultToSave[i].ShopkitPrice ==null){
                errorArr.push('Shopkit Price should not be null or empty. Please Check Row:' +a);
            }
             if(resultToSave[i].ShopkitSAPNumber =='' && resultToSave[i].ShopkitTemporaryItemNumbers ==''){
                 errorArr.push('Shopkit SAP and Temp Id both cannot be null or empty. Please Check Row:' +a);
            }
            if(resultToSave[i].ShopkitSAPNumber !='' && resultToSave[i].ShopkitTemporaryItemNumbers !='' ){
                errorArr.push('Either SAP or Temp Id should be present. Please Check Row:' +a);
            }
            if(resultToSave[i].ShopkitQty == '' || resultToSave[i].ShopkitQty ==null){
                errorArr.push('Shopkit Quantity should not be null or empty. Please Check Row:' +a);
            }
            if(resultToSave[i].BusinessLine == '' || resultToSave[i].BusinessLine ==null){
                errorArr.push('Business Line should not be null or empty. Please Check Row:' +a);
            }
        ...
        /*    if(blankValueRecords.length > 0){
            ...
            errorArr.push('Please fill all the blank values');
            ...
            errorArr.push($A.get("$Label.c.ABI_OP_ValidationSuccess"));
